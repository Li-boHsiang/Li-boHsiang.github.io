...
- Xiaorong He, **Bo Xiang**\*, Zeshui Xu, Dejian Yu. Exploring the evolution and collaboration in two-sided matching: A comprehensive bibliometric and topic modeling analysis. *International Journal of Intelligent Computing and Cybernetics* (EI/ESCI). Accepted.
...
- **Bo Xiang**, Dejian Yu\*, Zhuoya Pan, Wenjin Zuo. Detecting technology opportunities appropriate for enterprise R&D: The synthesis analysis of industrial technical windows and enterprise competition relations. *Technovation* (SSCI, Q1, ABS 3, FMS B). With Editor.
- **Bo Xiang**, Zhuoya Pan, Dejian Yu\*. Research on the technological competition pattern and breakthrough path of enterprises driven by innovation - A case study of the artificial intelligence industry. *Science and Technology Progress and Policy* (CSSCI, FMS T2). Under Review. `|` **项波**, 潘卓娅, 余德建\*. 创新驱动下企业的技术竞争模式与突破路径研究-以人工智能产业为例. 科技进步与对策 (CSSCI, FMS T2). 在审.
